...
public class FragmentMovielist3 extends Fragment {
    ...
    TextView moviename_textview3,movierate_textview3;
    ImageView mainimage_imageview3;
    MovieInfo movieInfo;
    MovieList movieList;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        moviename_textview3 = (TextView) rootView.findViewById(R.id.moviename_textview3);
        movierate_textview3 = (TextView) rootView.findViewById(R.id.movierate_textview3);
        mainimage_imageview3 = (ImageView) rootView.findViewById(R.id.mainimage_imageview3);
        requestMovieList();
    ...
    public void sendImageRequest() {
        ...
        ImageLoadTask task = new ImageLoadTask(url,mainimage_imageview3);
        task.execute();
    }
    ...
    public void processResponse(String response) {
        ...
        if(check.code == 200) {
            ...
            movieInfo = movieList.result.get(2);
            moviename_textview3.setText("3."+movieInfo.title);
            String rate = Float.toString(movieInfo.reservation_rate);
            String grade = Integer.toString(movieInfo.grade);
            movierate_textview3.setText("예매율 "+rate+"%"+" | "+grade+"세 관람가");
