...
public class FragmentMoviedetail extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        poster = (ImageView)rootView.findViewById(R.id.poster_imageview);

        return rootView;
    }
    public void onDetailChange(int index){
        if (index == 1) {
            poster.setImageResource(R.drawable.image11);
        } else if (index == 2) {
            poster.setImageResource(R.drawable.image22);
        } else if (index == 3) {
            poster.setImageResource(R.drawable.image33);
        } else if (index == 4) {
            poster.setImageResource(R.drawable.image44);
        } else if (index == 5) {
            poster.setImageResource(R.drawable.image55);
        } else if (index == 6) {
            poster.setImageResource(R.drawable.image66);
        }
    }
